...
class SnakeGame:
    ...
    def move_snake(self, direction=None):
        ...
        if next_step = self.apple:
            ...
            self.update_apple() # FIXME called outside
            return 1
    ...
    def same_or_opposite_direction(self, direction):
        if (direction is Direction.UP or direction is Direction.DOWN) and (self.direction is Direction.UP or self.direction is Direction.DOWN):
            return True
        if (direction is Direction.LEFT or direction is Direction.RIGHT) and (self.direction is Direction.LEFT or self.direction is Direction.RIGHT):
            return True
        return False
